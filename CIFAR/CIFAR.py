...
parser.add_argument('--depth', default=40, type=int,
                    metavar='N', help='Depth of the network (default: 40)')
parser.add_argument('--widen-factor', default=2, type=int,
                    metavar='N', help='widen-factor (default: 2)')
...
parser.add_argument('--nscale', default=2, type=int,
                    metavar='N', help='nScale (default: 2)')
args = parser.parse_args()

use_cuda = (args.gpu >= 0) and torch.cuda.is_available()
best_prec1 = 0
writer_comment = '_'.join(['', args.model, 'lr', str(args.lr), 
            '{}x{}x{}x{}'.format(args.depth, args.widen_factor, args.nchannel, args.nscale),
...
# Load model
model = get_network_fn(args.model, args.depth, args.widen_factor, args.dropout_rate, num_classes, args.nchannel, args.nscale)
print(model)
...
optimizer = optim.SGD(model.parameters(), lr=args.lr, momentum=args.momentum, weight_decay=3e-04, nesterov=True) # ????
